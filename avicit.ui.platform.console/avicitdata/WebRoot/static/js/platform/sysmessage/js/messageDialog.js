       ...
       var Message = {
            ...
            init: function(sysMessageId,currBaseUrl) {//创建HTML 弹出窗口
                ...
                this.win.innerHTML = '<div class="icos"><a style="border:none;" href="javascript:void(0)"  id="msg_readed" >'+
                	   ...
                	   '<a href="javascript:void(0)" title="最小化" id="msg_min">0</a><a href="javascript:void(0)" title="返回" id="msg_close">r</a></div>'+
...
function updateMessageStatus(sysMessageId,sysMessageStatus,doradoFlag,currBaseUrl){
	$.ajax({
	     ...
	     url: currBaseUrl+"platform/sysmessage/sysMessageController/updateSysMessageReadStatus.json",//要访问的后台地址
	...
	try{
		timeId=setInterval(function(){
			 $.ajax({
			     ...
			     dataType: "json",//返回json格式的数据
			     async : false,
			     url: baseUrl+"platform/sysmessage/sysMessageController/getLatestMessageByReceiveUserId.json",//要访问的后台地址
