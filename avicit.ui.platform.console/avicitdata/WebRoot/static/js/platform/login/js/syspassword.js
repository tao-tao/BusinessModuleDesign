...
$(function(){
	$.ajax({
		url : path+'platform/syspasswordtemplate/sysPasswordTemplateController/getChangeSelfPasswordVo',
		data : {
...
function closeParentDialog(state){
	if(state == '1'){
		...
		parent.$("#modify_dialog_login").dialog('close');
	}else{
		parent.$("#modify_dialog_login").dialog('close');
	}
};
...
function changePassword()
{
	...
	$.ajax({
		url : path+'platform/syspassword/sysPasswordController/changePassword',
		data : {
