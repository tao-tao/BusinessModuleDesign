...
<body  class="easyui-layout">
				...
				<form id="formAddBaseInfo" method="post">
					<table>
						<tr>
							<td width="80" align="right">
								<input title="用户主键" type="hidden" name="id" id="id" value="${userId}"/>
								<label>用户编号</label>
							</td>
							<td align="right" width="170">
								<span class="requiedbox" style="width: 170px;">
									<span>
								  	...
								  	<input title="用户编号" class="easyui-validatebox" type="text" name="no" id="no" data-options="required:true" onblur="checkUserCode(this,'');" onfocus="checkInUserCode(this);"/>
								</span>
							</td>
						...
						<tr>
							...
							<td align="right" width="170">
								<span class="requiedbox" style="width: 170px; height: 23px;">
								  	...
								  	<input title="登录名" class="easyui-validatebox" type="text" name="loginName" id="loginName" data-options="required:true" onblur="checkLoginName(this,'');" onfocus="checkInLoginName(this);"/>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="right" width="170">
								<span class="requiedbox" style="width: 170px; height: 23px;">
									<span>
								  	...
								  	<input title="用户姓名" class="easyui-validatebox" type="text" name="name" id="name" data-options="required:true"/>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="right" width="170">
								  	<input title="英文名" class="easyui-validatebox" type="text" name="nameEn" id="nameEn"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
					...
					<table>
						<tr>
							...
							<td align="right" width="170">
								...
								<span class="requiedbox" style="width: 168px;_width:170px; height: 23px;">
									...
									<span class="selectbox" style="width: 151px;_width:151px; height: 20px;">
										<input type="text" id="positionName" class="selectbox-text easyui-validatebox" data-options="required:true" name="positionName" readonly="readonly" style="width: 128px; height: 20px; line-height: 20px;" value="${defpositionName}"/>
										<span>
						...
						<tr>
							...
							<td align="right" width="168">
								...
								<span class="requiedbox" style="width: 168px;_width:170px; height: 23px;">
									...
									<span class="selectbox" style="width: 151px;_width:151px; height: 20px;">
										<input type="text" id="ruleName" class="selectbox-text easyui-validatebox" data-options="required:true" name="ruleName" readonly="readonly" style="width: 128px; height: 20px; line-height: 20px;" value="${defruleName}"/>
										<span>
						...
						<tr>
							...
							<td align="right" width="168">
								<select class="easyui-combobox" data-options="{panelHeight:'auto',editable:false,width:'151'}" name="degree" id="degree" title="学历">
						...
						<tr>
							...
							<td>
								<input title="手机" class="easyui-numberbox" type="text" name="mobile" id="mobile"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
							...
							<td align="right" width="168">
								<input title="办公电话" class="easyui-numberbox" type="text" name="officeTel" id="officeTel" />
							</td>
							<td width="70" align="right">
								<label>传真</label>
							</td>
							<td>
								<input title="传真" class="easyui-numberbox" type="text" name="fax" id="fax"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
							...
							<td align="right" width="168">
								<input class="inputbox" data-options="validType:'email'" type="text" name="email" id="email"/>
							</td>
							<td width="70" align="right">
								<label>工作地点</label>
							</td>
							<td>
							  	<input title="工作地点" class="inputbox" type="text" name="workSpace" id="workSpace"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
							...
							<td align="right" width="168">
								  	<input title="房间号" class="inputbox" type="text" name="roomNo" id="roomNo"/>
							</td>
							<td width="70" align="right">
								<label>家庭住址</label>
							</td>
							<td>
								  	<input title="家庭住址" class="inputbox" type="text" name="homeAddress" id="homeAddress"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
							...
							<td align="right" width="168">
								  	<input title="家庭邮编" class="inputbox" type="text" name="homeZip" id="homeZip"/>
							</td>
							<td width="70" align="right">
								<label>家庭电话</label>
							</td>
							<td>
							  	<input class="inputbox" type="text" name="homeTel" id="homeTel"/>
							</td>
						</tr>
						<tr>
							<td width="80" align="right">
							...
							<td align="right" width="168">
								  	<input title="排序编号" class="easyui-numberbox"  type="text" name="orderBy" id="orderBy"/>
							</td>
							<td width="80" align="right">
								<label>集团编码</label>
							</td>
							<td>
								  	<input title="集团编码" class="easyui-validatebox" type="text" name="unitCode" id="unitCode" onblur="checkUnitCode(this,'');" onfocus="checkInUnitCode(this);"/>
							</td>
						</tr>
						<tr>
	...
	<div id="toolbar" class="datagrid-toolbar datagrid-toolbar-extend">
		<table class="tableForm" border="0" cellspacing="1" width='100%'>
			<tr>	
				<td width="60%" align="right"><a title="保存" id="saveButton"  class="easyui-linkbutton" iconCls="" plain="false" onclick="saveForm();" href="javascript:void(0);">保存</a>
				
				<a title="保存" id="saveAndNewButton"  class="easyui-linkbutton" iconCls="" plain="false" onclick="saveAddForm();" href="javascript:void(0);">保存并继续</a>
	...
	<div id="addUserPhotoDialog" class="easyui-dialog" data-options="iconCls:'icon-add',resizable:true,modal:false,title:'上传头像'" style="width: 600px;height:200px;">
		<form action="platform/sysuser/photo/upload/headerphoto" method="post" id="uploadForm" enctype="multipart/form-data" style="margin-top: 20px;">
		...
		<div id="upLoadPhotoToolbar" class="datagrid-toolbar datagrid-toolbar-extend" style="height:auto;display: block;">
			<table class="tableForm"  width='100%'>
				<tr>	
					<td align="right"><a title="上传" id="upLoadButton"  class="easyui-linkbutton" iconCls="icon-save" plain="false" onclick="upLoadUserPhoto();" href="javascript:void(0);">上传</a></td>
	...
	<div id="addUserSignDialog" class="easyui-dialog" data-options="iconCls:'icon-add',resizable:true,modal:false,title:'上传签名'" style="width: 600px;height:200px;">
		...
		<div id="upLoadSignToolbar" class="datagrid-toolbar datagrid-toolbar-extend" style="height:auto;display: block;">
			<table class="tableForm"  width='100%'>
				<tr>	
					<td align="right"><a title="上传" id="upLoadSignButton"  class="easyui-linkbutton" iconCls="icon-save" plain="false" onclick="upLoadUserSign();" href="javascript:void(0);">上传</a></td>
