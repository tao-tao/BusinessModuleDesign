...
<body class="easyui-layout" fit="true">
	...
	<div data-options="region:'north'" split="false" style="height: 180px;border-left: 0;border-right: 0;border-top: 0;overflow: hidden;">
		<form id="formJob" fit="true">
			...
			<div class="formExtendBase">
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_group">
				<div class="formUnit column2">
					<label class="labelbg">任务分组</label>
					<div class="inputContainer">
						<input style="width:210px;" id="group" name="group" title="任务分组" class="easyui-combobox" type="text" value="<%=Job.DEFAULT_GROUP %>"
				...
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_name">
				<div class="formUnit column2">
					<label class="labelbg">任务名称</label>
					<div class="inputContainer">
						<input style="width:90%;" id="name" name="name" title="任务名称" class="easyui-validatebox" type="text" data-options="required:true" />
					</div>
				</div>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_type">
				<div class="formUnit column2">
					<label class="labelbg">任务类型</label>
					<div class="inputContainer">
						<input style="width:210px;" id="type" name="type" title="任务类型" class="easyui-combobox" 
				...
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_cron">
				<div class="formUnit column2">
					<label class="labelbg">表达式</label>
					<div class="inputContainer input-readonly">
						<input style="width:213px;" id="cron" name="cron" title="表达式" class="easyui-subwindow" type="text" data-options="required:true,onClick:openSelectCron" value="0/5 0/6 * ? * *" />
					</div>
				</div>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_typeRemark">
				...
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_program">
				<div class="formUnit column1">
					<label class="labelbg">执行程序</label>
					<div class="inputContainer">
						<input style="width:90%;" id="program" name="program" title="执行程序" class="easyui-validatebox" type="text" data-options="required:true" value="" />
					</div>
				</div>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="jobMaintainAdd_form_description">
				<div class="formUnit column1">
					<label>描述</label>
					<div class="inputContainer" >
						<input style="width:90%;" id="description" name="description" title="描述" class="easyui-validatebox" type="text" data-options="required:false" value="" />
					</div>
				</div>
				</sec:accesscontrollist>
			</div>
	...
	<div data-options="region:'south',height:getHeight()" split="false" title="排除日期" collapsible="false" style="border-left: 0;border-right: 0;border-bottom: 0;">
		...
		<!-- 		<a class="easyui-linkbutton" iconCls="icon-ok" id="addJobButton" onclick="addJob();" href="javascript:void(0);">完成</a>
				<a class="easyui-linkbutton" iconCls="icon-no" onclick="doCancel();" href="javascript:void(0);">取消</a> -->
				<table class="tableForm" border="0" cellspacing="1" width='100%'>
					<tr>	
						<td width="60%" align="right"><a title="保存" id="saveButton"  class="easyui-linkbutton" plain="false" onclick="addJob();" href="javascript:void(0);">保存</a>
