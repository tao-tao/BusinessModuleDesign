...
<form id="swfform" name="swfform" method="post" enctype="multipart/form-data">
	<table width="95%" cellspacing="1" cellpadding="1" border="0" align="center">
		...
		<tr>
			<td>
				<TABLE id="idFileList" width="100%" border="0" cellpadding="1" cellspacing="1">
					<tr style="background:url('avicit/platform6/component/js/jQuery/jquery-easyui-1.3.5/themes/gray/images/title.jpg')" height="25px;">
							<td align="center">
...
<div id="uploadCountDiv" style="padding-top: 5px; display: none;">
	<div style="display: none">
		</span>等待上传 <span id="idFileListCount">0</span> 个 ，已上传 <span id="idFileListSuccessUploadCount">0</span> 个。&nbsp;&nbsp;
	</div>
