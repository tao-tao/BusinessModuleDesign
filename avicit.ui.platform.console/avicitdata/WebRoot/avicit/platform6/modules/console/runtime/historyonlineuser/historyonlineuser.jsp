...
jQuery.ajax({type : 'POST',
	data : data,
	url : 'platform/console/historyOnlineUserAction/getHistoryOnlineUser?para=<%= request.getParameter("para")%>',
	dataType : "text",
	success : function(msg) {
		var chart = new FusionCharts("avicit/platform6/modules/system/fusionchar/charts/Line.swf?ChartNoDataText=没有数据!","ChartId","90%","90%");
