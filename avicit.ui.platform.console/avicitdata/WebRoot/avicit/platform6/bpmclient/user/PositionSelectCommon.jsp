...
var baseurl = '<%=request.getContextPath()%>';
	...
	//面门的调用方式
// 	function eventClick(){
// 		var usd = new UserSelectDialog('roleSelectCommonDialog',700,400,getPath() + '/platform/user/bpmSelectUserAction/positionSelectCommon?isMultiple=true','地址簿');
// 		var buttons = [{
// 			text:'确定',
// 			id : 'processSubimt',
// 			iconCls : 'icon-submit',
...
function loadOrgTree(){
	 $('#orgTree').tree({
 		 ...
 		 onBeforeExpand:function(node,param){
			...
			$('#orgTree').tree('options').url = getPath() + beforeExpandUrl + 'appId='; //appId为应用ID，备用
	    }
 	 });
}
/**
