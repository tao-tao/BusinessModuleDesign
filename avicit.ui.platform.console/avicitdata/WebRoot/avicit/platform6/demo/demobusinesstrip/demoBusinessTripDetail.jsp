			...
			<input type="hidden" name="id" value='${demoBusinessTripDTO.id}'/>
				<table width="100%" style="padding-top: 10px;">
					<tr>
						...
						<td>
							  <input title="用户id" class="inputbox" style="width: 180px;" type="text" name="userId" id="userId" readonly="readonly" value='${demoBusinessTripDTO.userId}'/>
						</td>
						<th align="right">用户名称 :</th>
						<td>
							 <input title="用户名称" class="inputbox" style="width: 180px;" type="text" name="userName" id="userName" readonly="readonly" value='${demoBusinessTripDTO.userName}'/>
						</td>
					</tr>
					<tr>
						<th align="right">出差地址:</th>
						<td>
							  <input title="出差地址" class="inputbox" style="width: 180px;" type="text" name="address" id="address" readonly="readonly" value='${demoBusinessTripDTO.address}'/>
						</td>
						<th align="right">出差事由 :</th>
						<td>
							 <input title="出差事由 " class="inputbox" style="width: 180px;" type="text" name="matter" id="matter" readonly="readonly" value='${demoBusinessTripDTO.matter}'/>
						</td>
					</tr>
					<tr>
						<th align="right">出差借款:</th>
						<td>
							  <input title="出差借款" class="easyui-numberbox" style="width: 180px;" type="text" name="lendmoney" id="lendmoney" readonly="readonly" value='${demoBusinessTripDTO.lendmoney}'/>
						</td>
						<th align="right">交通工具:</th>
						<td>
							 <input title="交通工具" class="inputbox" style="width: 180px;" type="text" name="traffic" id="traffic" readonly="readonly" value='${demoBusinessTripDTO.traffic}'/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							  <input title="出差总结" class="inputbox" style="width: 180px;" type="text" name="summary" id="summary" readonly="readonly" value='${demoBusinessTripDTO.summary}'/>
						</td>
						<th align="right">返回补助:</th>
						<td>
							 <input title="返回补助" class="easyui-numberbox" style="width: 180px;" type="text" name="allowance" id="allowance" readonly="readonly" value='${demoBusinessTripDTO.allowance}'/>
						</td>
					</tr>
				</table>
		</form>
