...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false" style="padding-bottom:32px;overflow: auto;">
		...
		<input type="hidden" name='id' id='id' value='${treeDemo.id}'/>
		<input type="hidden" name='parentId' id='parentId' value='${treeDemo.parentId}'/>
		<table class="table" width="100%" style="padding-top: 4px;">
			<tr>
				<th align="right" width="85px">编码</th>
				<td>
					<input title="编码" class="inputbox"  type="text" name="code" id="code" value='${treeDemo.code}'/>
				</td>
			</tr>
			<tr>
				<th align="right" width="85px">名称</th>
				<td>
					<input title="名称" class="inputbox"  type="text" name="name" id="name" value='${treeDemo.name}'/>
				</td>
			</tr>
		</table>
	</form>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.treeDemo.closeDialog("#modify");
		}
		function saveForm(){
			parent.treeDemo.save(serializeObject($('#form')),'${url}','#modify','${id}');
		}
	</script>
</body>
</html>