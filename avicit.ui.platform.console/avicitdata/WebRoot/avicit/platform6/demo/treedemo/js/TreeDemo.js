 ...
 * 
 */
function TreeDemo(tree,url,searchId){
...
//初始化操作
TreeDemo.prototype.init=function(){
	var _self = this;
...
//选择根节点
TreeDemo.prototype.selectRootNode=function(self){
...
TreeDemo.prototype.loadMenuById=function(_self,node){
	/*$.ajax({
        cache: true,
        type: "get",
...
//添加平级菜单
TreeDemo.prototype.insert=function(){
...
//添加子菜单
TreeDemo.prototype.insertsub=function(){
	this._iDg=new CommonDialog("insert","700","400",this.getUrl()+'/operation/add/'+this._selectNode.id,"添加节点",false,true,false);
	this._iDg.show();
};

//添加子菜单
TreeDemo.prototype.modify=function(){
	this._eDg=new CommonDialog("modify","700","400",this.getUrl()+'/operation/modify/'+this._selectNode.id,"编辑节点",false,true,false);
	this._eDg.show();
};

TreeDemo.prototype.save=function(form,url,dialog,id){
	var _self = this;
	$.ajax({
		 url:url,
...
TreeDemo.prototype.del=function(){
...
//关闭对话框
TreeDemo.prototype.closeDialog=function(id){
	$(id).dialog('close');
};
