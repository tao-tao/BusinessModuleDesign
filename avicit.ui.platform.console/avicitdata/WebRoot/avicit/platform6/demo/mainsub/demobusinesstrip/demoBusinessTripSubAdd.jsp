...
<body class="easyui-layout" fit="true">
			...
			<input type="hidden" name="parentId" id="parentId" value='${pid}'/>
				<table width="100%" style="padding-top: 10px;">
					<tr>
						...
						<td>
							  <input title="出差地点" class="inputbox" style="width: 180px;" type="text" name="address" id="address"/>
						</td>
						<th align="right">出差内容:</th>
						<td>
							 <input title="出差内容" class="inputbox" style="width: 180px;" type="text" name="content" id="content"/>
						</td>
					</tr>
					<tr>
						<th align="right">出差借款:</th>
						<td>
							  <input title="出差借款" class="easyui-numberbox" style="width: 180px;" type="text" name="lendmoney" id="lendmoney"/>
						</td>
					</tr>
				</table>
		</form>
	...
	function closeForm(){
		parent.demoBusinessTripSub.closeDialog("#insert");
	}
	function saveForm(){
		parent.demoBusinessTripSub.save(serializeObject($('#form')),"#insert");
	}
	</script>
</body>
</html>