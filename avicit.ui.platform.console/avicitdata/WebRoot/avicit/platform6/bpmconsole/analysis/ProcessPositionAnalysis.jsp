...
<head>
	...
	<script type="text/javascript">
		...
		function doQueryAll(tab){
			var startDate =$("#"+tab+"Search input[comboname=startDate]").datetimebox('getValue');
			var endDate =$("#"+tab+"Search input[comboname=endDate]").datetimebox('getValue');
		    var url  = getPath()+"/avicit/platform6/bpmconsole/analysis/ProcessPositionAnalysisAll.jsp";
			var title = "统计信息";
			...
			top.addTab(title,url,"dorado/client/skins/~current/common/icons.gif","ProcessPositionAnalysisAll"," -0px -120px");
		}
