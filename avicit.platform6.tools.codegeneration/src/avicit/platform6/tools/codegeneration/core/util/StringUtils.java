...
public abstract class StringUtils {
    ...
    public static void main(String args[]) {
        //String path="/c:\\aaa aa/afdsfds\\lixin/lixin.txt";
//        String path="/c:\\aaa aa/.././adfdf/cdf/../../afdsfds\\lixin/lixin.txt";
//        System.out.println(StringUtils.cleanPath(path));
//        String aa="/erp/dwr/call/plaincall/NseerModuleTreeNode.Category.dwr";
//        System.out.println(aa.split("/")[1]);

        String aab = "001002003004";

        System.out.println(aab.substring(0,aab.length() - 3));
