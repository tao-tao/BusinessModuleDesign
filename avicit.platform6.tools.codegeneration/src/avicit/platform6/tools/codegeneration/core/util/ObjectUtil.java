...
public abstract class ObjectUtil {
 ...
 /**
     ...
     * 将对象的数组转换为字符类型的数组
     *
     * @param objects Object[] 对象的数组
     * @return String[] 字符的数组
     */
    public static String[] ObjectsToStringArray(Object[] objects) {
        String[] ret = null;
        if (objects == null)
            return new String[0];
        ret = new String[objects.length];
    ...
    public static void main(String[] arg){
    	long timeValue=365;
    	long hour = timeValue/(60*60*1000); 
    	long minute = (timeValue - hour*60*60*1000)/(60*1000); 
    	long second = (timeValue - hour*60*60*1000 - minute*60*1000)/1000; 
    	...
    	String onlineTime="";
    	if(hour==0){
    		onlineTime=minute +" 分钟 "+second+" 秒";
    	}
    	if(minute==0){
    		onlineTime=second+" 秒";
    	}
    	if(second==0){
    		onlineTime=timeValue+" 毫秒";
    	}
