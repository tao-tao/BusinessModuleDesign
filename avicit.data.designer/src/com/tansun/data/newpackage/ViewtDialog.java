...
import com.tansun.data.db.visual.editpart.ColumnSelectDialog;
 ...
 */
public class ViewtDialog extends Dialog {
...
//	private TableViewer indexColumns;
	 ...
	 * @param sql SQL
	 */
	public ViewtDialog(Shell parentShell, RootModel rootModel, String tableName,
	...
	@Override protected Control createDialogArea(Composite parent) {
		...
		// shihuifeng add new code
		UIUtils.createLabel(group, "reference table");
		cmbColumnType = new Combo(group, SWT.READ_ONLY);
		txtColumnLogicalName.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		txtColumnLogicalName.addFocusListener(updateColumnListener);
		UIUtils.createLabel(group, "reference column");
		cmbColumnType = new Combo(group, SWT.READ_ONLY);
		txtColumnLogicalName.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		txtColumnLogicalName.addFocusListener(updateColumnListener);
