...
public class EditeJavaAction extends SelectionAction {
	...
	public void openFile(TableModel model) {
		try {
			...
			IFile file = project.getFile(File.separator+model.getPath()+File.separator+model.getJavaName());
			IDE.openEditor(page, file);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			//MessageDialog.openError(Display.getDefault().getActiveShell(), "提示", "路径有误");
		}
