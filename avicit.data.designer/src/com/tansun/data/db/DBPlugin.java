...
import com.tansun.data.db.sqleditor.EditorColorProvider;
import com.tansun.data.db.util.ColorRegistry;
...
public class DBPlugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "avicit.data.designer";
