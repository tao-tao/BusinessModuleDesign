 ...
 * 
 */
public abstract class TableSelectionDialog extends SelectionDialog {
	private static final String DEFAULT_TITLE = "Dialog.TableViewerSelectionDialog.DefaultTitle"; //$NON-NLS-1$
	 ...
	 * @param parentShell
	 */
	public TableSelectionDialog(Shell parentShell, String statusMessage,
			int style) {
		super(parentShell);
	...
	protected void createTableViewer(Composite parent) {
		if((this._style & SWT.CHECK) >0)
			_tableViewer = new CheckboxTableViewer(parent, _style);
		else
			_tableViewer = new TableViewer(parent, _style);
	...
	private void setTableViewerProviders() {
		...
		_tableViewer.setSorter(_viewerSorter);
		_tableViewer
		...
		_tableViewer.setInput(findInputElement());
	...
	public void createTreeViewerComposite(Composite parent) {
		...
		createTableViewer(treeViewerComposite);
	...
	public void setSelectedElement(Object[] selection) {
		...
		_tableViewer.setSelection(new StructuredSelection(_selection), true);
	}
