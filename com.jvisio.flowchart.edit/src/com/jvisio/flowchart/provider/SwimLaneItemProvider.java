...
/**
 * This is the item provider adapter for a {@link com.jvisio.flowchart.SwimLane} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowchartPackage.Literals.SWIM_LANE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SwimLane_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SwimLane_type_feature", "_UI_SwimLane_type"),
				 FlowchartPackage.Literals.SWIM_LANE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
