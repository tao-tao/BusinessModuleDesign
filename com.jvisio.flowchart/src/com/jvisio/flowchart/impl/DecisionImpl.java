 ...
 * <ul>
 *   <li>{@link com.jvisio.flowchart.impl.DecisionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecisionImpl extends EObjectImpl implements Decision {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowchartPackage.DECISION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowchartPackage.DECISION__NAME:
				return getName();
		}
