...
//                if(this.extHeaderStyle === true)
////                {
//                	this.header.dom.innerHTML =
//	                	'<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>'+
//	                	'<TBODY><TR class=table_r1_center><TD class=table_r1_left></TD><TD class=table_r1_center_span>'+
//	                    '<span class="' + this.headerTextCls + '">'+this.header.dom.innerHTML+'</span>'
//	                    +'</TD><TD class=table_r1_right width=10></TD></TR><TR></TBODY></TABLE>';
////                }
//                else
//                {
                	this.header.dom.innerHTML =
...
Ext.DataView = Ext.extend(Ext.BoxComponent, {
    ...
    setStore : function(store, initial){
        ...
        if(store){
            ...
            store.on("metachange", this.onMetaChange, this); //added by yangzhenhua
        }
        this.store = store;
        if(store){
            this.refresh();
...
Ext.extend(Ext.form.Action.Submit, Ext.form.Action, {
    ...
    type : 'submit',
        ...
        return {success:true};//Ext.decode(response.responseText);
    }
});
...
Ext.extend(Ext.grid.GridView, Ext.util.Observable, {
    ...
    afterRender: function(){
    	if(this.ds) //added by yangzhendhua
    	{
