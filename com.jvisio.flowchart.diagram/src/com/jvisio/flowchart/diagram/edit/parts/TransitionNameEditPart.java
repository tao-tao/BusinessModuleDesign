...
import com.jvisio.flowchart.diagram.edit.policies.FlowchartTextSelectionEditPolicy;
...
public class TransitionNameEditPart extends LabelEditPart implements
	 ...
	 */
	static {
		registerSnapBackPosition(FlowchartVisualIDRegistry
				.getType(TransitionNameEditPart.VISUAL_ID), new Point(0, 40));
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return FlowchartElementTypes.Transition_3001;
					}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), FlowchartEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new TransitionNameFigure();
	}

	/**
	 * @generated
	 */
	public class TransitionNameFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public TransitionNameFigure() {
