package com.jvisio.flowchart.diagram.view.factories;
 ...
 * @generated
 */
public class WaitViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = FlowchartVisualIDRegistry
					.getType(com.jvisio.flowchart.diagram.edit.parts.WaitEditPart.VISUAL_ID);
		...
		if (!FlowchartEditPart.MODEL_ID.equals(FlowchartVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", FlowchartEditPart.MODEL_ID); //$NON-NLS-1$
			view.getEAnnotations().add(shortcutAnnotation);
		}
		getViewService().createNode(semanticAdapter, view,
				FlowchartVisualIDRegistry.getType(WaitNameEditPart.VISUAL_ID),
