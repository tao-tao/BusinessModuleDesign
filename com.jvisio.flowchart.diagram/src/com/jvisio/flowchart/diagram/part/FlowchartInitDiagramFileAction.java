...
public class FlowchartInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new FlowchartNewDiagramFileWizard(mySelectedModelFile,
				myPart.getSite().getPage(), mySelection, diagramRoot,
				editingDomain);
		IDialogSettings pluginDialogSettings = FlowchartDiagramEditorPlugin
		...
		wizard.setWindowTitle("Initialize new " + FlowchartEditPart.MODEL_ID
				+ " diagram file");
