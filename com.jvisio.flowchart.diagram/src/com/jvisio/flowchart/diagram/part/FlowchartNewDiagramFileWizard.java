...
public class FlowchartNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public FlowchartNewDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		assert selectedModelFile != null : "Null selectedModelFile in FlowchartNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert workbenchPage != null : "Null workbenchPage in FlowchartNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert selection != null : "Null selection in FlowchartNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert diagramRoot != null : "Null diagramRoot in FlowchartNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert editingDomain != null : "Null editingDomain in FlowchartNewDiagramFileWizard constructor"; //$NON-NLS-1$
	...
	public void addPages() {
		myFileCreationPage = new WizardNewFileCreationPage(
			...
			public void createControl(Composite parent) {
				...
				String originalFileName = mySelectedModelFile
						...
						.lastSegment();
				String fileExtension = ".fcd"; //$NON-NLS-1$
		...
		myFileCreationPage.setDescription("Create new diagram based on "
				+ FlowchartEditPart.MODEL_ID + " model content");
