 ...
 * @generated
 */
public class FlowchartDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createAndOpenDiagram(
		...
		IFile diagramFile = FlowchartDiagramEditorUtil.createNewDiagramFile(
	...
	public static final IFile createNewDiagramFile(
		...
		IPath modelFileRelativePath = diagramFile.getFullPath()
				.removeFileExtension().addFileExtension("fcm"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static Flowchart createInitialModel() {
		return FlowchartFactory.eINSTANCE.createFlowchart();
	}

	/**
	 * @generated
	 */
	private static EObject createInitialRoot(Flowchart model) {
		return model;
	}
}
