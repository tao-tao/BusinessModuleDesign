...
public class JavaBeanNode extends AbstractVirtualNode{
...
//	@Override
	...
	public boolean equals(Object arg0) {
		if(!(arg0 instanceof JavaBeanNode))
			return false;
		if(this.id != null)
			return id.equals(((JavaBeanNode)arg0).id);
    ...
    public Object getAdapter(Class adapter)
    {
        ...
        if(IDoubleClickListener.class == adapter)
        {
        	...
        	if(parent instanceof XmlNode){
        		...
        		//return new OpenBizAction(); update by lidong
        		return null;
        	}else
