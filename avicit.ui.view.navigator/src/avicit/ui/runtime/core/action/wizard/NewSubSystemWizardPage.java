...
public class NewSubSystemWizardPage extends WizardPage {
	...
	public NewSubSystemWizardPage(IStructuredSelection selection,Project obj) {
		super("wizardPage");
		setTitle("创建新元素");
...
//						folder = (IFolderDelegate) obj.getFolder(text_srcPath.getText()+"/"+name.trim());
