...
public class OpenBpelAction implements IDoubleClickListener{
	...
	public void doubleClick(DoubleClickEvent anEvent) {
		...
		if(file != null)
		{
			WorkbenchUtil.openFileInNewEditor(WorkbenchUtil.getWorkbenchPage(), file, WorkbenchUtil.EC_BIZ_ID);
		}
	}
