...
public class OpenServiceConfigAction implements IDoubleClickListener{
	...
	public void doubleClick(DoubleClickEvent anEvent) {
		...
		if(file != null)
		{
			WorkbenchUtil.openFile(WorkbenchUtil.getWorkbenchPage(), file, WorkbenchUtil.EC_SPRINGEDITOR_ID);
		}
	}
